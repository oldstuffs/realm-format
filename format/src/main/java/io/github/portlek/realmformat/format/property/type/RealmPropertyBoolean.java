...
public final class RealmPropertyBoolean extends RealmProperty<Boolean> {

  public RealmPropertyBoolean(
  ...
  public RealmPropertyBoolean(@NotNull final String nbtName, @NotNull final Boolean defaultValue) {
