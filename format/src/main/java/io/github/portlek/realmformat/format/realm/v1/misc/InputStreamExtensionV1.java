...
public class InputStreamExtensionV1 extends InputStreamExtension {
    ...
    @NotNull
    public Map<RealmFormatChunkPosition, RealmFormatChunk> readCompressedChunks()
        throws IOException {
    ...
    protected RealmFormatChunk[] readChunks() throws IOException {
        return this.readArray(
                ...
                () -> {
                    ...
                    final RealmFormatChunkSection[] sections =
                        this.readChunkSections(minSection, maxSection);
