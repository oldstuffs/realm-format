...
public final class AsyncPreCreateEmptyWorldEvent extends Event implements CancellableEvent {
  ...
  public AsyncPreCreateEmptyWorldEvent(
  ...
  public static HandlerList getHandlerList() {
    return AsyncPreCreateEmptyWorldEvent.HANDLER_LIST;
  }

  @NotNull
  @Override
  public HandlerList getHandlers() {
    return AsyncPreCreateEmptyWorldEvent.getHandlerList();
  }
}
