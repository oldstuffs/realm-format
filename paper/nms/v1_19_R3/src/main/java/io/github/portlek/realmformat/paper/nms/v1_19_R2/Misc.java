...
class Misc {
  ...
  static io.github.shiruka.nbt.Tag toTag(@NotNull final Tag tag) {
    return switch (tag.getId()) {
      ...
      case Tag.TAG_SHORT -> io.github.shiruka.nbt.Tag.createShort(((ShortTag) tag).getAsShort());
      ...
      case Tag.TAG_FLOAT -> io.github.shiruka.nbt.Tag.createFloat(((FloatTag) tag).getAsFloat());
